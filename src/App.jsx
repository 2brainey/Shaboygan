      ...
      >
        ...
        {elements.map(el => (
          <div
            ...
            className={`absolute flex items-center justify-center transition-shadow border-box
      ...
      <div className={`w-80 bg-gray-900 border-l border-gray-800 flex flex-col transition-all duration-300 ${mode === 'play' ? 'w-16' : ''}`}>
        ...
        {mode === 'play' && (
            <div className="flex-1 flex flex-col items-center gap-4 py-4 text-gray-600">
                ...
                <div className="w-1 h-1 bg-gray-800 rounded-full"></div>
                <div className="w-1 h-1 bg-gray-800 rounded-full"></div>
                <div className="writing-vertical-rl text-xs uppercase tracking-widest opacity-50" style={{ writingMode: 'vertical-rl' }}>
                    Game Running
                </div>
            </div>
        )}
